...
input_folder <- "G:/FINAL USES DATA/Data/SPI ALL/SPI-12/SPI-12 ALL/SPI_12/"
#G:\FINAL USES DATA\Data\SPI ALL\SPI-12\SPI-12 ALL\SPI_12
output_folder <- "G:/FINAL USES DATA/Reprojected_All data/SPI-3,6,12/SPI-12/"
#G:\FINAL USES DATA\Reprojected_All data\SPI-3,6,12
...
# Print the list of TIFF files being processed
print("The following TIFF files will be processed:")
print(tif_files)

# Check if files are being loaded correctly
if (length(tif_files) == 0) {
  stop("No TIFF files found in the specified folder. Please check the folder path and file names.")
}
...
print("All files have been reprojected and resampled.")
